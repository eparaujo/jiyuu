...
class EventForm(forms.ModelForm):
        ...
        class Meta:
            model = models.Event
            fields = ['name', 'kind', 'level', 'date', 'start_time', 'end_time', 'local', 'address', 'description', 'hability_graduation', 'category', 'modality', 'registration_fee',
            ...
            widgets = {
                ...
                'hability_graduation': forms.SelectMultiple(attrs={"class": "form-control"}),
                'category': forms.SelectMultiple(attrs={"class": "form-control"}),
                'modality': forms.SelectMultiple(attrs={"class": "form-control"}),
